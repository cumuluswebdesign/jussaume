    ...
    <div id="butcher-block-menu" class="secondary-header">
        <div class="header-container">
            <div class="header-content">
                <div class="navigation">
                    <ul>
                        <li><a href="table-tops.php" class="<?php if ($page == "table-tops") {echo ' active';} ?>">Tabletop</a></li>
                        <li><a href="countertop.php" class="<?php if ($page == "countertops") {echo ' active';} ?>">Countertop</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="header-content">
                <div class="navigation">
                    <ul>
                        ...
                        <li><a href="materials.php" class="<?php if ($page == "materials") {echo ' active';} ?>">Materials</a></li>
                    </ul>
                </div>
            </div>
        </div>
